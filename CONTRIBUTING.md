...
## 2\. Padrões de Projeto (Java & JavaFX)
...
| :--- | :--- | :--- |
| **Views (FXML)** | `[Name]View.fxml` | `DashboardView.fxml` |
| **Controllers** | `[Name]Controller.java` | `DashboardController.java` |
...
> **Dica para Componentes UI:** Ao nomear componentes visuais (no FXML ou Java), adicione o tipo do componente como sufixo para facilitar a identificação:
>
>   * `Button` → `saveButton`
